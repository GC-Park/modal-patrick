...
var ModalPortal = function (props) {
    ...
    return ReactDom.createPortal(_jsx("dialog", __assign({ ref: modalRef, onKeyDown: dialogKeyDownListener, onClick: dialogBackdropListener }, { children: _jsx(ModalContainer, { children: props.children }) })), $modalRoot);
};
